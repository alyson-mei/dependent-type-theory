...
%Diagrams for the remark below in order
...
\begin{itemize}
    ...
    $$
        \Gamma \vdash M:A \quad \mapsto \quad \llbracket M \rrbracket : \Gamma \to A;
    $$
    ...
    \[\begin{tikzcd}
    	...
    	\arrow["{\case (x.N, y.P)(z)}"{description, pos=0.3}, dashed, from=2-2, to=3-2]
